...
var Dispatcher = (function () {
    ...
    Dispatcher.prototype.removeNamespaceCallback = function (namespace, callback) {
        var ns_array = this.namespace_callbacks[namespace];
    ...
    Dispatcher.prototype.removeCallback = function (event_type, callback) {
        var cb_array = this.callbacks[event_type];
